<%@ Page Language="C#" AutoEventWireup="true" CodeFile="marker.aspx.cs" Inherits="experiments_marker" %>
    ...
    function initialize() {
        ...
        $("#map_list ul li").each(function (index) {
            ...
            google.maps.event.addListener(marker, 'click', function () {
                map.panTo(new google.maps.LatLng($(this).children(".marker_long").text(), $(this).children(".marker_lat").text()));
