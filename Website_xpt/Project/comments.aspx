...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            var commentTable = (from tabl in context.commentData select tabl).OrderByDescending(tabl => tabl.commentId);
            name.Text = "";
            comment.Text = "";
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        var commentTable = (from tabl in context1.commentData select tabl).OrderByDescending(tabl => tabl.commentId);
...
<body>
    ...
    <div>
       <%-- <asp:Login ID="Login1" runat="server" LoginButtonText="Login" TitleText="Sign In to Post Comment" DestinationPageUrl="comments.aspx"
    ...
    <div>
        <%--<asp:LoginView ID="LoginView0" runat="server">
            <LoggedInTemplate>
                <asp:LoginStatus ID="LoginStatus1" runat="server" LogoutAction="Redirect" LogoutPageUrl="comments.aspx" />
                <p class="bold">
    ...
    <table class="style1">
        <tr>
            ...
            <td>
                ...
                <asp:RegularExpressionValidator ID="reg1" runat="server" ControlToValidate="name" ValidationExpression="^[a-zA-Z0-9 ]+$"
                 ErrorMessage="Please enter the name"></asp:RegularExpressionValidator>
