...
<div id="inputfield">
        <div>
            ...
            <span class="float_left"><asp:CheckBox ID="AutoFillCheck" runat="server" OnClick="initialize()" Text="AutoComplete" /></span>
         <span class="float_right">  <asp:CheckBox ID="nearbySearch" runat="server" Text="Search Nearby" OnClick="initialize()" CssClass="nearbysearch" /></span>
            </div>
...
<div id="reviews" class="comment-box-content">No reviews found for the search.</div>
</div>
