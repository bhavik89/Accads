...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            var commentTable = from tabl in context.projectComment select tabl;
    ...
    protected override void OnPreRender(EventArgs e)
    {
        ...
        var commentTable = from tabl in context1.projectComment select tabl;
...
<body>
    ...
    <%--<div>
        <asp:Login ID="Login1" runat="server" LoginButtonText="Login" TitleText="Sign In to Post Comment" DestinationPageUrl="Login.aspx"
    ...
    <div>
        <%--<asp:LoginView ID="LoginView0" runat="server">
            <LoggedInTemplate>
                <asp:LoginStatus ID="LoginStatus1" runat="server" LogoutAction="Redirect" LogoutPageUrl="userComments.aspx" />
                <p class="bold">
...
<asp:LoginStatus ID="LoginStatus2" runat="server" LoginText="Sign In">     
    ...
    <table class="style1">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="comment" runat="server" EnableTheming="False" Height="80px" TextMode="MultiLine" Width="548px" CssClass="style5" Enabled="true" Text="Comment Here (You must sign in before commenting)" Font-Size="Medium" ForeColor="#333333"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="style4">
