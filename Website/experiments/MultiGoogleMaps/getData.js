function DunkinDataSource() {
    ...
    var that = this;
   // var selection = document.getElementById("CoffeeSelect");
   // var coffeeSel = selection.getAttribute('value');
    
   // var selection = document.forms[0].
    document.write(coffeeSel);
 if(coffeeSel == 1)
document.getElementById("selected").text = "Dunkin";
else
document.getElementById("selected").text = "StarBucks";

   
    var datafile = 'dunkinData.csv';
