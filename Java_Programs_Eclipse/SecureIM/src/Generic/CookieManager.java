...
public class CookieManager {
	...
	public static boolean verifyCookie(InetAddress ip, String cookie) {
		System.out.println(cookie.replaceAll("\0", "").length());
		Cookie storedCookie = cookies.get(ip);
		Long inputCookie = null;
		try{
		inputCookie = Long.valueOf(cookie.replaceAll("\0", ""));
		}catch  (NumberFormatException e){
			System.out.println("Invalid long exception:" + e);
