 ...
 *
 * By default, preconfigured parameters (1024-bit prime modulus and base generator used by SKIP) are used.
...
public class DHKeyAgreement2 {
	...
	private void run(String mode) throws Exception {
		...
		if (mode.equals("GENERATE_DH_PARAMS")) {
			...
			//System.out.println(dhSkipParamSpec.toString());
		} else {
 ...
 */
 ...
 System.out.println("Generated Bob DES");
 ...
 System.out.println("Generated Alice DES");

 
 
 System.out.println("Alice AES secret: " + toHexString(aliceDesKey.getEncoded()));
 System.out.println("Bob AES secret: " + toHexString(bobDesKey.getEncoded()));
 ...
 */
 ...
 // Instantiate AlgorithmParameters object from parameter encoding obtained from Bob
